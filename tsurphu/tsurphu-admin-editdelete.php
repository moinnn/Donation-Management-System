...
include_once '../templates/TABLE_NAME_header.php'; 
                ...
                <div class="row">
                    <div class="col-lg-6" style="margin-bottom: 20px;">
                        ...
                        <?php 
                            ...
                            for($i=0; $i<$N; $i++)
                                {
                                    $result = mysql_query("SELECT * FROM ".TABLE_NAME." WHERE id='$edit_id[$i]'");
                        ...
                        ?>
                            ...
                            <div class="form-group">
                               ...
                               <select class="form-control" name="currency[]">
                                ...
                                <div style="float:left; margin:7px;">
                                    <label>&nbsp;</label>
                                    <input class="form-control" type="text" style="color:#999999;" name="num[]" id="num" value="<?php echo $row['amount_no']; ?>" >
                                 </div> 
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="amount_word[]" id="number" style="width: 47% !important; color:#999999;" value="<?php echo $row['amount_word']; ?>">
                                </div>
...
<?php
	...
	$del_id=$_POST['selector'];
		...
		for($i=0; $i<$d; $i++)
		{
		$delete = mysql_query("DELETE FROM ".TABLE_NAME." WHERE id='$del_id[$i]'");
		}
	if($delete){
		//If successful 
		...
		//header("Location: TABLE_NAME-search.php?message2=$d Record has Successfully Deleted");
//exit;
	}
	mysql_close();
